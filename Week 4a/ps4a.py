...
def updateHand(hand, word):
    ...
    returns: dictionary (string -> int)
    """
    #need to make a copy of the dict apparently:
    newhand = hand.copy()
    for letter in word:
    ...
    while calculateHandlen(hand) > 0:
        ...
        if inp == '.':
            ...
            if isValidWord(inp, hand, wordList) == False:
                ...
                totalscore += score
                print("\"%s\" earned %d points. Total: %d points" % (inp, score, totalscore))
...
def playGame(wordList):
    ...
    """
    while True:
       playerwants = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
       if playerwants == 'n':
